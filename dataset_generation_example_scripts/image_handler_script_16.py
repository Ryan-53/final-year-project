...
DIFFS_TXT_PATH = ROOT_FOLDER + "labels_16\\"
...
NUM_PATCHES = 16
NUM_GRIDLINES = 10 # 16=10, 64=18, 256=34

# Loads in loop number - 1 as loop number has already been iterated
loopNumber = int(load_loop_num(LOOP_TXT_PATH)) - 1
...
img = crop_image(ROOT_FOLDER, NUM_PATCHES, loopNumber)
